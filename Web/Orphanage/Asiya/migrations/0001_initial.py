    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('word_type', models.CharField(choices=[('Motion', 'Глагол'), ('Descriptor', 'Прилагательное'), ('NOUN', 'Существительное'), ('STATE', 'Состояние'), ('NOMIN', 'Местоимение'), ('SOUND', 'Звук'), ('PUNCTATION', 'Пунктуация'), ('NUM', 'Число'), ('UNION', 'Союз')], default='NOUN', max_length=16, verbose_name='Тип слова')),
                ('word_gender', models.CharField(choices=[('Male', 'Мужской'), ('Neutral', 'Средний'), ('NONE', 'Без рода'), ('Female', 'Женский')], default='NONE', max_length=16, verbose_name='Род слова')),
